Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   An elegant “pull to refresh” animation, written in Objective-C, fix the crash when dealloc 
                   DESC
  ...
  s.source       = { :git => "https://github.com/luckymore0520/LMPullToBounce.git", :tag => "1.1.1" }
